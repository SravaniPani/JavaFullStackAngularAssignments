...
public class NewsAssign {
    ...
    {
        News news1 = new News(1, "Srav", "vani", "comment");
        News news2 =new News(2, "Srav1", "vani1", "budget");
        News news3 = new News(1, "Srav2", "vani2", "comment");
        News news4 = new News(3, "Srav3", "vani", "budget");
        News news5 = new News(1, "Srav4", "vani2", "comment");
        News news6 = new News(3, "Srav5", "vani", "budget");
        News news7 = new News(1, "Srav6", "vani6" ,"comment");
